...
_log_msg "Running bats uninstall script for location: ${location_path}"

_log_msg "No bats-specific external files to clean up."

_log_msg "bats uninstall script finished."
