...
_log_msg "Running bats switch script for version ${version} at location: ${location_path}"

executable_abs_path="${location_path}/bin/bats"
...
_log_msg "bats switch script finished successfully."
