...
_log_msg "Running k9s uninstall script for location: ${location_path}"

_log_msg "No k9s-specific external files to clean up."

_log_msg "k9s uninstall script finished."
