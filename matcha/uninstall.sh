...
_log_msg "Running matcha uninstall script for location: ${location_path}"

_log_msg "No matcha-specific external files to clean up."

_log_msg "matcha uninstall script finished."
