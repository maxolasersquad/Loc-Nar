...
_log_msg "Running nom uninstall script for location: ${location_path}"

_log_msg "No nom-specific external files to clean up."

_log_msg "nom uninstall script finished."
