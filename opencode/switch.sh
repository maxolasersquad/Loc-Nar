...
_log_msg "Running opencode switch script for version ${version} at location: ${location_path}"

executable_abs_path="${location_path}/opencode"
...
_log_msg "opencode switch script finished successfully."
exit 0
