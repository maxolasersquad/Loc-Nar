...
_log_msg "Running zellij uninstall script for location: ${location_path}"

_log_msg "No zellij-specific external files to clean up."

_log_msg "zellij uninstall script finished."
