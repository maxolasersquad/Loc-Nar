...
_log_msg "Running zellij switch script for version ${version} at location: ${location_path}"

executable_abs_path="${location_path}/zellij"
...
_log_msg "zellij switch script finished successfully."
