...
_log_msg "Running signal-cli switch script for version ${version} at location: ${location_path}"

executable_abs_path="${location_path}/bin/signal-cli"
...
_log_msg "signal-cli switch script finished successfully."
